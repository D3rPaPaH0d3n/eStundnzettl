// ============================================================
// MIGRATION.TS - Einmalige Migrationen für eStundnzettl
// ============================================================
 ...
 */
const migrateKoglerKeys = (): void => {
  const alreadyMigrated = localStorage.getItem("estundnzettl_migrated");
  if (alreadyMigrated) return;

  Object.keys(OLD_KEYS).forEach((key) => {
    const oldKey = OLD_KEYS[key as keyof typeof OLD_KEYS];
    const newKey = NEW_KEYS[key as keyof typeof NEW_KEYS];
