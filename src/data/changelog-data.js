...
export const CHANGELOG_DATA = [
  ...
  },
  {
    version: "7.0.1",
    date: "29.03.2026",
    title: "Google Drive jetzt ohne spontane Login-Popups ☁️",
    isMajor: false,
    sections: [
      {
        iconName: 'Cloud',
        title: "Google Drive",
        items: [
          "Google Drive verbindet sich jetzt nur noch dann, wenn du es wirklich willst",
          "Neuer nativer Google-Drive-Backup-Pfad für Android",
          "Backups laufen über den geschützten Google-Drive-App-Datenbereich"
        ]
      },
      {
        iconName: 'Bug',
        title: "Bugfixes",
        items: [
          "Spontane Google-Login-Popups im Hintergrund entfernt",
          "Abgelaufene Google-Verbindungen werden jetzt sauber erkannt",
          "Backup-Status zeigt klarer, wenn Google Drive neu verbunden werden muss"
        ]
      },
      {
        iconName: 'Zap',
        title: "Verbesserungen",
        items: [
          "Changelog in der App auf den aktuellen Stand gebracht",
          "Google-spezifische Änderungen sauber auf den aktuellen Nextcloud-Stand übernommen"
        ]
      }
    ]
  },
