...
let _ready: Promise<boolean> | null = null; // true = SQLite verfügbar, false = Fallback
let _dbOpen = false;
 ...
 * @param set - Array von Statements mit Werten
 * @param transaction - in Transaktion wrappen (default: true)
 */
export async function executeSet(set: ExecuteSetItem[], transaction = true): Promise<any> {
