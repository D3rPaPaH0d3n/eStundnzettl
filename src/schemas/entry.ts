 ...
 */
export function parseEntrySafe(value: unknown): z.infer<typeof entrySchema> | null {
 ...
 */
export function filterValidEntries(candidates: unknown): z.infer<typeof entrySchema>[] {
  if (!Array.isArray(candidates)) return [];
  const valid: z.infer<typeof entrySchema>[] = [];
