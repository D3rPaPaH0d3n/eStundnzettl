...
export interface LiveTimerOverlayProps {
  timerState: {
    isRunning: boolean;
    isPaused: boolean;
...
const LiveTimerOverlay: React.FC<LiveTimerOverlayProps> = ({
  timerState,
  onCreateEntry,
  onStart,
  onStop,
  ...
  const [displayStatus, setDisplayStatus] = useState<DisplayStatus>({ text: "...", tone: "blue" });
  ...
  useEffect(() => {
    ...
    const update = () => {
      ...
      let tone: DisplayStatus['tone'] = "blue";
      if (targetMinutes > 0) {
