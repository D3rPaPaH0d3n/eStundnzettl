...
import { z } from "zod";
import * as entrySchemas from "./entry";
...
export const backupPayloadSchema = z
  .object({
    ...
    // Payload
    user: z.any().optional(), // Using z.any() instead of z.record(z.any()) to avoid Zod version issues
    entries: z.array(entrySchemas.entrySchema).optional().default([]),
...
export function parseBackupPayloadSafe(value: any) {
