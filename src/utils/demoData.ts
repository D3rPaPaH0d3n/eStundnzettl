...
import { toLocalDateString } from "../utils.jsx";
import { calculateEntryNetDuration } from "./timeCalculations";
import { Entry, UserData, WorkCodeItem } from "../types";
...
const DEMO_WORK_CODES: WorkCodeItem[] = [
...
// _daysAgo function removed - unused
