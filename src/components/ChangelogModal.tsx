...
interface ChangelogVersion {
  ...
  isBugfixGroup?: boolean;
  groupedVersions?: ChangelogVersion[];
}

const groupBugfixVersions = (data: ChangelogVersion[]): ChangelogVersion[] => {
...
const ChangelogModal = ({ isOpen, onClose }: Props) => {
  ...
  const renderVersion = (version: ChangelogVersion, isFirst: boolean) => {
