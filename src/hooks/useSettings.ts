/**
 * useSettings.ts — Hook für App-Settings
 *
...
export function useSettings() {
  ...
  // Nextcloud
  const [nextcloudEnabled, setNextcloudEnabled] = useState<boolean>(
  ...
  const [nextcloudUser, setNextcloudUser] = useState<string>(
  ...
  const [nextcloudPass, setNextcloudPass] = useState<string>(
  ...
  const sqliteWrite = useCallback(async (key: string, value: any) => {
